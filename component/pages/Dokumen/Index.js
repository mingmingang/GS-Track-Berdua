...
import i18n from "../../backbone/i18n"; // ⬅️ kamu sudah punya

const folderData = [
  { key: "cuti", color: "#DCEEFF", iconColor: "#3A82EE", size: "2 MB" },
  { key: "izinDinasLuar", color: "#FFF3C4", iconColor: "#FFAF00", size: "1 MB" },
  ...
  { key: "reimburseObat", color: "#FFF3C4", iconColor: "#FFAF00", size: "850 KB" },
  { key: "pusaka", color: "#FDE2E2", iconColor: "#E74C3C", size: "720 KB" },
  { key: "izinMeninggalkanPekerjaan", color: "#D0F0EF", iconColor: "#00B894", size: "900 KB" },
  { key: "permintaan", color: "#DCEEFF", iconColor: "#3A82EE", size: "1.5 MB" },
];

const DokumenFolderScreen = () => {
  const renderItem = ({ item }) => (
    <TouchableOpacity style={[styles.folderCard, { backgroundColor: item.color }]}>
      <View style={styles.folderRow}>
        <MaterialCommunityIcons name="folder" size={30} color={item.iconColor} />
