  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        />
        <Text style={styles.headerText}>Izin Meninggalkan Pekerjaan</Text>
        <View style={{ width: 24 }} />
      </ImageBackground>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.dateRangeBox}>
          ...
          <View style={styles.iconsRight}>
            ...
            />
            <TouchableOpacity onPress={() => navigation.navigate("FilterIMP")}>
          ...
          <View key={item.id} style={styles.card}>
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate("LihatIMP")}
              >
      ...
      <TouchableOpacity
        style={styles.fab}
        onPress={() => navigation.navigate("TambahIMP")}
      >
