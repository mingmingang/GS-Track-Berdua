...
const TambahIMPScreen = () => {
  ...
  // Single location state (instead of multiple locations)
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        />
        <Text style={styles.headerText}>Pengajuan IMP</Text>
        <View style={{ width: 24 }} />
      </ImageBackground>
      ...
      >
        ...
        <View style={styles.noteContainer}>
          ...
          <Text style={styles.noteText}>
            Pengisian IMP dilakukan paling lambat H-1
          </Text>
        </View>
...
export default TambahIMPScreen;
