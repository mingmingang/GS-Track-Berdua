          ...
          <View style={styles.statusBox}>
            <View style={styles.statusRow}>
              ...
              <Text style={styles.statusText}>
                Keterangan : Pengajuan IDL yang anda ajukan sedang dalam proses
            ...
            <View style={styles.statusRow}>
              ...
              <Text style={styles.statusText}>
                Keterangan : Pengajuan IDL yang anda ajukan telah diverifikasi
            ...
            <View style={styles.statusRow}>
              ...
              <Text style={styles.statusText}>
                Keterangan : Pengajuan IDL yang anda ajukan ditolak.
              </Text>
            </View>
          </View>
        </View>
